...
```
La function table compte le nombre de fois que chaque variable est présent dans les itérations. Le meilleure modèle semble être quand toutes les variables sont presents lors des 10 simulations. 
