...
La méthode pmm est très répandue car elle est facile à utiliser, elle forme un petit ensemble des donneurs à partir des cas complets, avec des valeurs prédits proches des valeurs prédits par les données manquantes.
