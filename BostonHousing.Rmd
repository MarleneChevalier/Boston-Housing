...
En dernier, nous allons vérifier l'ajustement du modèle d'imputation.
(en cours je n'arrive pas encore a le faire)

```{r diagnostics3}

#overimpute(impregsto, nnodes = 5)

##overimpute(impforest, main="Forêts aléatoires", layout = c(2, 3))
##overimpute(imppmm, main="Predictive mean matching", layout = c(2, 3))
```

**Conclusion**

Les résultats des trois modes d'imputation nous conduisent vers des modèles qui sont très similaires, avec les mêmes estimateurs, mêmes résidus et le même R2 ajustée.
(en cours)
