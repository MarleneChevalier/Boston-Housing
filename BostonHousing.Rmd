---
title: "Projet données manquantes : Valeur du logement en banlieue de Boston"
...
Il s'agit de traiter les données manquantes du fichier Boston Housing. Ce fichier décrit la situation de logements dans les villes de la banlieue de Boston. Il est constitué de 506 enregistrements et de 14 variables quantitatives :
...
Nous utiliserons ces données pour tenter d'expliquer la valeurs médiane des habitations privées (MDEV) en fonction des autres variables du fichier.
