...
Graphiquement (*cf.annexe 1.1*), on observe que :   
   ...
   - L' **accessibilité aux autoroutes** 
   - La **proximité avec la rivière Charles** 
...
Nous allons ici en tester 2 : la suppression par paire etl'imputation par regression stochastique.
