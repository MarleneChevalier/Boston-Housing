...
ggplot(data=dHB, aes(x = MEDV, y=MEDV, color = "black")) +
geom_line()

#ggplot(data=d.precipmonth, mapping=aes(x = as.factor(Month), y = MeanPrecip)) +
 # geom_bar(stat="identity", col="black",fill="deepskyblue3",width = 1) + 
...
En sortie, 2 graphiques :  
  - le graphique de gauche donne la proportion de données maquantes de chaque variable : ici on retrouve des proportions égales pour les variables CRIM, ZN, INDUS, CHAS (autour de 4%)  
  - le graphique de droite donne la proportion de chaque structure de données.   
  Ici 78% du jeux de données est complet pour toutes les variables, 3.8% ont uniquement la données de la variable CRIM qui n'est pas renseignée, ...
...
### annexe 1.1 : graphiques sur le jeu complet  
